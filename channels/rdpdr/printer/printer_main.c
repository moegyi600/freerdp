 ...
 *
 * Copyright 2010-2011 Vic Lee (original file)
 * Copyright 2012 Ulteo SAS http://www.ulteo.com (Ulteo PDF Printer)
...
#endif
#ifdef WITH_ULTEO_PDF_PRINTER
	DEBUG_SVC("ULteo driver registered");
    driver = printer_ulteo_pdf_get_driver();
#endif
	if (driver == NULL)
	{
